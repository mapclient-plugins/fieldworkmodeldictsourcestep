...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def _makeConnections(self):
        ...
        self._ui.lineEdit1.textChanged.connect(self._fileLocEdited)
    ...
    def validate(self):
        ...
        self._ui.lineEdit0.setStyleSheet(DEFAULT_STYLE_SHEET if idValid else INVALID_STYLE_SHEET)
        fileLocValid = os.path.exists(
            os.path.join(
    ...
    def getConfig(self):
        ...
        config['Config File'] = self._ui.lineEdit1.text()
        return config
    ...
    def setConfig(self, config):
        ...
        self._ui.lineEdit1.setText(config['Config File'])
    ...
    def _fileLocClicked(self):
        ...
        if location:
            ...
            self._ui.lineEdit1.setText(os.path.relpath(location, self._workflow_location))
